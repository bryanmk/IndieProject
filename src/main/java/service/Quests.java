...
//        return range;
     ...
     */
    public static List<String> queryValues (List<Integer> quests) {
...
//                            dao.getAnswer((quests.get(i))).getRewards().getExperience()) + "')" );
    ...
    /**
     * Method that makes it all go. Ends up writing an SQL statement that I use to insert API data into my database.
     * Calls getQuests() to retrieve an ArrayList<Integer>
     * Calls queryValues() while passing in the ArrayList
     * Calls toFile() passing in the ArrayList<String> returned by queryValues()
     * @param args
     */
